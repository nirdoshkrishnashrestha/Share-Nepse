...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownBtn = $('<button type="button" class="btn btn-default dropdown-toggless" data-toggle="dropdown">' + this.options.i18n.display + ' <span class="caret"></span></button>');
