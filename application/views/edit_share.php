...
<br />
		...
		<div class="container-login" style="background-image: url('images/bg-01.jpg');">
			...
			<?php echo form_open('share/update_share'); ?>
					...
					<span class="login-form-title p-b-34 p-t-27">
                      ...
                      <div>  
                         ...
                         <option value="<?php echo $edit->share_name; ?>"><?php echo $edit->share_name; ?></option>
                    ...
                    <?php echo form_error('date'); ?>
						<input class="input" value="<?php echo $edit->date; ?>" type="text" name="date" placeholder="Enter Buy Date">
					</div>
                   

					<div class="wrap-input validate-input" data-validate="Enter rate">
                    	 <?php echo form_error('buy_rate'); ?>
						<input class="input" value="<?php echo $edit->buy_rate; ?>" type="text" name="buy_rate" placeholder="Enter Buy Rate" required>
					</div>
                    <input type="hidden" name="id" value="<?php echo $edit->share_id; ?>"  />
                   
                    <div class="wrap-input validate-input" data-validate = "No of Shares">
                   	    <?php echo form_error('num'); ?>
						<input class="input" value="<?php echo $edit->num; ?>" type="text" name="num" placeholder="Enter No. of Shares" required>
					</div>
