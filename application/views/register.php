			...
			<?php echo form_open('auth/register_data'); ?>
					...
					echo form_error('username');
					 ...
					 ?>
						...
						<input class="input" type="text" value="<?php if($this->session->has_userdata('username')){ echo $this->session->username;}?>" name="username" placeholder="Username" required>
					</div>
                    ...
                    <div class="wrap-input validate-input" data-validate = "Enter Email">
						...
						<input class="input" type="email" value="<?php if($this->session->has_userdata('email')){ echo $this->session->email;}?>" name="email" placeholder="E-mail" required>
					</div>
                    
                    <div class="wrap-input validate-input" data-validate = "Enter Mobile">
                    	 <?php echo form_error('mobile'); ?>
						<input class="input" type="text" value="<?php if($this->session->has_userdata('mobile')){ echo $this->session->mobile;}?>" name="mobile" placeholder="Mobile" required>
					</div>
